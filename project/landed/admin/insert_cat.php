...
if(isset($_REQUEST['insert'])){
	...
	extract($_REQUEST);
		...
		if($connection->Insert("categories","name='$name',status='$status'")){
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-12">
                        <h4 class="page-title">Inseart category</h4>
                    </div>
                </div>
            ...
            <div class="container-fluid">
				...
				<form action="" method="post">
					<table style="width:600px; margin:0 auto" class="table table-bordered table-hover table-stripped table-condensed" border="1" cellpadding="5" cellspacing="0">
						...
						<tr>
							<td colspan="2" class="text-center"><input type="submit" class="btn btn-primary" name="insert" value="Add New Category"></td>
